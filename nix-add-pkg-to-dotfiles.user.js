...
const OPERATIONS = [
    Object(userscripter_lib_operations__WEBPACK_IMPORTED_MODULE_1__["operation"])({
        ...
        action: () => {
            const selector = "ul.search-result-button";
            ...
            setTimeout(() => {
                ...
                searchResults.forEach((resultRow) => {
                    const appName = resultRow.textContent;
                    if (appName === null) {
