...
// @version    0.1.0.2021.10.27.18.13
...
const OPERATIONS = [
    Object(userscripter_lib_operations__WEBPACK_IMPORTED_MODULE_1__["operation"])({
        ...
        action: () => {
            ...
            setTimeout(() => {
                console.log("nix add pkg timeout running");
