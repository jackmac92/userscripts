...
// @version    0.1.0.2021.10.27.17.59
...
const OPERATIONS = [
    Object(userscripter_lib_operations__WEBPACK_IMPORTED_MODULE_1__["operation"])({
        ...
        action: () => {
            console.log("nix add pkg running!");
            const searchResults = Array.from(document.querySelectorAll("ul.search-result-button"));
