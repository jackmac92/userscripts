...
const OPERATIONS = [
    Object(userscripter_lib_operations__WEBPACK_IMPORTED_MODULE_3__["operation"])({
        ...
        action: () => {
            ...
            if (!localStorage.getItem(`hackydanger-allowed-${atob}`) &&
                confirm("Ok to run command?")) {
                localStorage.setItem(`hackydanger-allowed-${atob}`, "surethisistottallysafe");
            }
