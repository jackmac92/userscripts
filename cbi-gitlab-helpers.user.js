...
// @version    0.1.0.2022.2.9.23.7
// @match      *://gitlab.cbinsights.com/*
// @license    GPL-3.0-or-later; http://www.gnu.org/licenses/gpl-3.0.txt
// @namespace  jackmscripts
// @run-at     document-end
// @updateURL  https://openuserjs.org/meta/jackm92/Cbi_Gitlab_Helpers.meta.js
// ==/UserScript==
        ...
        action: () => {
            ...
            document.addEventListener("readystatechange", (event) => {
                ...
                if (document.readyState === "complete") {
                    ...
                    setTimeout(() => {
                        console.debug("timeout running!");
                        const elQuery = "div.blocks-container p > span";
                        const info = Array.from(document.querySelectorAll(elQuery)).filter((e) => { var _a; return (_a = e === null || e === void 0 ? void 0 : e.textContent) === null || _a === void 0 ? void 0 : _a.includes("Runner"); })[0];
                        if (info === null) {
                            console.error("Didnt find job runner info", elQuery);
                            return;
                        }
                        //@ts-expect-error
                        ...
                        const params = {
                            targetExecStr: `direnv exec ~/cbinsights cbi-ssh ${targetIp}`,
                        };
