...
// @version    0.1.0.2021.10.29.21.38
            ...
            document.addEventListener("readystatechange", (event) => {
                ...
                if (document.readyState === "complete") {
                    ...
                    setTimeout(() => {
                        ...
                        const elQuery = "div.blocks-container > div:nth-child(2) > p:nth-child(3) > span";
                        const info = document.querySelector(elQuery);
                        if (info === null) {
