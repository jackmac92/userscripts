...
// @version    0.1.0.2021.10.28.19.45
        ...
        action: () => {
            ...
            document.addEventListener("readystatechange", (event) => {
                ...
                if (document.readyState === "complete") {
                    ...
                    const info = document.querySelector("div.blocks-container > div:nth-child(2) > p:nth-child(3) > span");
                    if (info === null) {
